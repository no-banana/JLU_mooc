package com.jlu_mooc.generator;
...
//			"mq_message_history"
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/JLU_mooc_generator/src/main/java");
		gc.setAuthor("wysit");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://192.168.155.129:3306/JLU_mooc"
